...
<div class="content">
	<div class="panel panel-flat">
		<div class="panel-heading">
			<h5 class="panel-title">Création d'un commentaire client</h5>
		...
		<form method="post">
			...
			<div class="row">
				...
				<?php if($id): ?>
					...
					<br><br>
				<?php endif; ?>
				<label class="col-md-12" for="textarea2">Commentaire : </label>
				<div class="col-md-8">
					<textarea  class="form-control" rows="6" <?php echo $form["commentaire"]?>><?php echo $oForm->getData("commentaire")?></textarea>
				</div>
