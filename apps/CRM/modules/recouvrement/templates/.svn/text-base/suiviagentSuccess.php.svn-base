...
<div class="page-header">
  <div class="breadcrumb-line">
    <ul class="breadcrumb">
      ...
      <li class="active">Suivi les recouvrement par agent</li>
    </ul>
  </div>
</div>
<!-- /page header -->
...
<div class="content">
	<div class="panel panel-flat">
		<div class="panel-heading">
			<h5 class="panel-title">Suivi des recouvrement par agent</h5>
    		...
    		<table class="table table-hover table-striped" id="tableau">
				...
				<?php $total_ht = 0; foreach ($datas as $row):?>
					<tr>
						...
						ondblclick='window.open("<?php echo url_for('DetailRecouvrement',array('act'=>'appel','agent'=>$row['code_commercial'],'date_from'=>$oFilter->getValue('date_from'),'date_to'=>$oFilter->getValue('date_to'))); ?>", "_blank");'><?php echo number_format($row["nbr_appel"],0,'',''); $nbr_appel+=$row["nbr_appel"]; ?></td>
						<td style="cursor: pointer; cursor: hand;"
						ondblclick='window.open("<?php echo url_for('DetailRecouvrement',array('act'=>'visite','agent'=>$row['code_commercial'],'date_from'=>$oFilter->getValue('date_from'),'date_to'=>$oFilter->getValue('date_to'))); ?>", "_blank");'><?php echo number_format($row["nbr_visite"],0,'',''); $nbr_visite+=$row["nbr_visite"]; ?></td>
