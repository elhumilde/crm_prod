    	   ...
    	   <table  id="tableau2" class="display table table-striped table-hover">
				<thead>
					<tr>
						...
						<th class="optional">Contact</th>
						<th class="optional">Heure rappel</th>
				...
				<?php foreach ($data as $row):?>
					<tr style="cursor: pointer; cursor: hand;"
						...
						<td><?php if(substr($row["appel_heure_rappel"],0,2))  echo substr($row["appel_heure_rappel"],0,2).":".substr($row["appel_heure_rappel"],-2) ?></td>
