...
$response = $this->context->getResponse();
  ...
  $response->addMeta('title', 'ERP', false, false);
  $response->addMeta('description', 'ERP', false, false);
  ...
  $response->addJavascript('theme_limitless/plugins/tables/datatables/datatables.js', '', array ());
  $response->addJavascript('theme_limitless/pages/form_layouts.js', '', array ());
  $response->addJavascript('theme_limitless/plugins/ui/moment/moment.min.js', '', array ());
  $response->addJavascript('theme_limitless/plugins/pickers/daterangepicker.js', '', array ());
  $response->addJavascript('theme_limitless/plugins/pickers/anytime.min.js', '', array ());
  $response->addJavascript('theme_limitless/plugins/pickers/pickadate/picker.js', '', array ());
  $response->addJavascript('theme_limitless/plugins/pickers/pickadate/picker.date.js', '', array ());
  $response->addJavascript('theme_limitless/plugins/pickers/pickadate/picker.time.js', '', array ());
  $response->addJavascript('theme_limitless/plugins/pickers/pickadate/legacy.js', '', array ());
  ...
  $response->addJavascript('theme_limitless/pages/picker_date.js', '', array ());
