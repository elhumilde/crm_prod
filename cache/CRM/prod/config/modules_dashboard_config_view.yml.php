...
$response = $this->context->getResponse();
  ...
  $response->addMeta('title', 'WIMECOM', false, false);
  $response->addMeta('description', 'WIMECOM', false, false);
  ...
  $response->addJavascript('theme_limitless/plugins/visualization/echarts/echarts.js', '', array ());
  $response->addJavascript('theme_limitless/plugins/visualization/d3/d3.min.js', '', array ());
