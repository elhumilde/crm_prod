...
abstract class sfApplicationConfiguration extends ProjectConfiguration
{
  ...
  public function setRootDir($rootDir)
  {
    ...
    if(is_readable(sfConfig::get('sf_apps_dir').DIRECTORY_SEPARATOR.$this->getApplication())) $this->setAppDir(sfConfig::get('sf_apps_dir').DIRECTORY_SEPARATOR.$this->getApplication());
    else $this->setAppDir(sfConfig::get('sf_apps_dir_new').DIRECTORY_SEPARATOR.$this->getApplication());
  }
