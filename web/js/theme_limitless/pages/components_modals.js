...
$(function() {
    ...
    $('.confirm_supp').on('click', function(event) {
        ...
        swal({
            title: "Vous \352tes sur?",
            text: "Vous ne pourrez pas r\351cup\351rer cette ligne !",
            type: "warning",
            showCancelButton: true,
            confirmButtonColor: "#EF5350",
            confirmButtonText: "Oui, supprimer cette ligne!",
            ...
            if (isConfirm) {
                lots_of_stuff_already_done = true; // set flag
                 window.location.href = event.currentTarget.href;
                    swal({
                    title: "Supprimer!",
                    text: "la ligne a  \351t\351 supprim\351.",
                    confirmButtonColor: "#66BB6A",
                    type: "success"
                });
            }
                ...
                swal({
                    title: "Annuler",
                    text: "la suppression est annul\351 :)",
                    confirmButtonColor: "#2196F3",
                    type: "error"
                });
            }
