    ...
    $.fn.makeEditable = function (options) {
        ...
        function _fnApplyEditable(aoNodes) {
            ...
            var oDefaultEditableSettings = {
                ...
                "callback": function (sValue, settings) {
                 ...
                 //   alert("toto");
                    ...
                    if (sNewCellValue == sValue) {
                        ...
                        oTable.fnUpdate(sNewCellDisplayValue, aPos[0], aPos[2],false);
                        //oTable.fnUpdate(sNewCellDisplayValue, aPos[0], 3);
                        status = "success";
                    } else {
                        var aPos = oTable.fnGetPosition(this);
                        oTable.fnUpdate(sOldValue, aPos[0], aPos[2],false);
                        //oTable.fnUpdate(sOldValue, aPos[0], 3);
                    ...
                    if (settings.fnOnCellUpdated != null) {
                        settings.fnOnCellUpdated(status, sValue, aPos[0], aPos[1], settings);
                    }
                ...
                "submitdata": function (value, settings) {
                    ...
                    var others = settings.sOthersParam;
            ...
            if (properties.aoColumns != null) {
                for (var i = 0; i < properties.aoColumns.length; i++) {
                    if (properties.aoColumns[i] != null) {
                        cells = $("td:nth-child(" + (i + 1) + "):not(." + properties.sReadOnlyCellClass + ")", aoNodes);
        ...
        */
        ...
        return this.each(function () {
            ...
            $(document).on('click', '.table-action-deletelink', oTable,function(e){
                    e.preventDefault();
                    e.stopPropagation();
