  ...
  public function Header()
  {
    if ($this->print_header)
    {
      if (is_null($this->headerCallback))
      {
	        ...
	        $signature = <<<EOD
	        <br><br>
 <table width="500px" border="2" align="center"  bordercolor="#000000">
      	          		                         
      	          		                                 <tr><td width="36%"><br><div align="center">
      	          		                           	<img src="/img/logo_ERP.png"  width="169" height="70" /> </div>   
    	
      	          		                                 </td >
      	          		  		                       <td  width="48%" bgcolor="#FFFFFF" ><br><br/><b><div align="center"><span style="font-size:55px"><strong> MISE A DISPOSITION ET ENGAGEMENT OUTILLAGE </strong> 
      	          		                            </span>
      	          		                          </div></b>
      	          		                                      </td> 
      	          		                                      <td width="42%" ><br>
      	          		                                      <div align="left"><span style="font-size:45px">&nbsp;Code.MG-FR17<br/>&nbsp;Version : 01 <br/>&nbsp;Date d'application :11/05/2012<br/>
      	          		                                      &nbsp; Pages : {$this->getAliasNumPage()} / {$this->getAliasNbPages()}
      	          		                                      </span></div>
      	          		                                      </td >              
      	          		                                </tr>
