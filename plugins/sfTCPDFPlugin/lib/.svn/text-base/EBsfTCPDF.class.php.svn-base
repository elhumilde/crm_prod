...
class EBsfTCPDF extends TCPDF
{
 ...
 <table width="500px" border="2">
      	          		     ...
      	          		     <tr><td width="40%"><br><div align="center"><br>
      	          		      <img src="/img/logo_ERP.png"  width="180" height="70" /> </div>   
                              </td > <td  width="48%" ><br><br/><b><div align="center"><span style="font-size:50px"><br><strong> EXPRESSION DE BESOIN </strong> 
      	          		       </span>
      	          		       </div></b>
      	          		             </td> 
      	          		             <td width="42%" ><br><br/>
      	          		             <div align="left"><span style="font-size:45px"> Code.MG-FR10<br/>&nbsp;Version : 04 <br/>&nbsp;Date d'application :11/05/2012<br/>
