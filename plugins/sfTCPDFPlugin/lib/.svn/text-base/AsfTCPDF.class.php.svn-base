...
class AsfTCPDF extends TCPDF
{
 ...
 <table width="500px" border="2" align="center"  bordercolor="#000000">
      	          		                           	...
      	          		                           	<img src="/img/logo_ERP.png"  width="169" height="70" /> </div>   
      	          		  		                       ...
      	          		  		                       <td  width="48%" bgcolor="#FFFFFF" ><br><br/><b><div align="center"><span style="font-size:55px"><strong> MISE A DISPOSITION ET ENGAGEMENT  </strong> 
      	          		                            </span>
      	          		                          </div></b>
      	          		                                      </td> 
      	          		                                      <td width="42%" ><br>
      	          		                                      <div align="left"><span style="font-size:45px">&nbsp;Code.MG-FR11<br/>&nbsp;Version : 05 <br/>&nbsp;Date d'application :11/05/2012<br/>
